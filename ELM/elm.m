function [ TrainingAccuracy, TestingAccuracy,Sensitivity,Specificity,Gmean,Fscore] = elm(TrainingData_File, TestingData_File, Elm_Type, NumberofHiddenNeurons, ActivationFunction)
